...
public class PlayerShip : MonoBehaviour
{
    ...
    {
        if (Keyboard.current.wKey.isPressed) _throttle += throttleAdjustSpeed * Time.deltaTime;
        if (Keyboard.current.sKey.isPressed) _throttle -= throttleAdjustSpeed * Time.deltaTime;
        
        if (Keyboard.current.aKey.isPressed) _direction += directionAdjustSpeed * Time.deltaTime;
        if (Keyboard.current.dKey.isPressed) _direction -= directionAdjustSpeed * Time.deltaTime;
